 ...
 */
function ehh_block_editor_styles() {

	$css_dependencies = array();

	// Enqueue the editor styles.
	wp_enqueue_style( 'ehh-block-editor-styles', get_theme_file_uri( '/css/custom-editor-style.min.css' ), $css_dependencies, wp_get_theme()->get( 'Version' ), 'all' );
	
	wp_enqueue_style( 'ehh-font-sans', 'https://use.typekit.net/njo8rca.css', array() );

	wp_style_add_data( 'ehh-block-editor-styles', 'rtl', 'replace' );

}

add_action( 'enqueue_block_editor_assets', 'ehh_block_editor_styles', 1, 1 );
 ...
 *
*/
function ehh_acf_extension_enqueue() {
...
add_action( 'acf/input/admin_enqueue_scripts', 'ehh_acf_extension_enqueue' );
