...
if ( ! function_exists( 'ehh_pagination' ) ) {
	/**
	 ...
	 */
	function ehh_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'ehh' ),
				'next_text'          => __( '&raquo;', 'ehh' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'ehh' ),
			)
		);
